...
export default function Dashboard() {
  ...
  const statCards = [
    { title: 'Total de Posts', value: stats.posts, icon: FileText, color: 'text-primary' },
    { title: 'Categorias', value: stats.categories, icon: FolderTree, color: 'text-accent' },
    { title: 'Usuários', value: stats.users, icon: Users, color: 'text-success' },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {statCards.map((stat, index) => (
            <Card key={stat.title} className="animate-slide-up" style={{ animationDelay: `${0.1 * index}s` }}>
